...
public sealed class BlindnessPotionModifier(PlayerControl alchemist) : TimedModifier, IPotionEffect
{
    public override string ModifierName => TouLocale.Get("TouJKRoleAlchemistPotionBlindnessPotionEffect");
    ...
    public string PotionName => TouLocale.Get("TouJKRoleAlchemistPotionBlindnessPotion");
    ...
    public override void FixedUpdate()
    {
        ...
        {
            VisionPerc = Mathf.Lerp(1f, opts.BlindnessPotion, opts.PotionDurationLong - TimeRemaining);
        }
        else if (TimeRemaining < 1f)
        {
            VisionPerc = Mathf.Lerp(1f, opts.BlindnessPotion, TimeRemaining);
        }
        else
        {
            VisionPerc = opts.BlindnessPotion;
        }
    }
