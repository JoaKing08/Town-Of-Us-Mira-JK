...
public sealed class InfluencePotionModifier(PlayerControl alchemist) : BaseModifier, IPotionEffect
{
    public override string ModifierName => TouLocale.Get("TouJKRoleAlchemistPotionInfluencePotionEffect");
    ...
    public string PotionName => TouLocale.Get("TouJKRoleAlchemistPotionInfluencePotion");
