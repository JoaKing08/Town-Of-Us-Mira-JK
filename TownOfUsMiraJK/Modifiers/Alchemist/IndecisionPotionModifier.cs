...
public sealed class IndecisionPotionModifier(PlayerControl alchemist) : BaseModifier, IPotionEffect
{
    public override string ModifierName => TouLocale.Get("TouJKRoleAlchemistPotionIndecisionPotionEffect");
    ...
    public string PotionName => TouLocale.Get("TouJKRoleAlchemistPotionIndecisionPotion");
