...
public sealed class SpeedPotionModifier(PlayerControl alchemist) : TimedModifier, IVisualAppearance, IPotionEffect
{
    public override string ModifierName => TouLocale.Get("TouJKRoleAlchemistPotionSpeedPotionEffect");
    ...
    public string PotionName => TouLocale.Get("TouJKRoleAlchemistPotionSpeedPotion");
    ...
    public VisualAppearance GetVisualAppearance()
    {
        ...
        appearance.Speed *= OptionGroupSingleton<AlchemistOptions>.Instance.SpeedPotion;
        return appearance;
    }
