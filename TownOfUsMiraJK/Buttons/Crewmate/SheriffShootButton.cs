...
public sealed class SheriffShootJKButton : TownOfUsKillRoleButton<SheriffRole, PlayerControl>, IKillButton
{
    ...
    public bool FailedShot
    {
        get
        {
            return CustomButtonSingleton<SheriffShootButton>.Instance.FailedShot;
        }
        set
        {
            CustomButtonSingleton<SheriffShootButton>.Instance.FailedShot = value;
        }
    }
