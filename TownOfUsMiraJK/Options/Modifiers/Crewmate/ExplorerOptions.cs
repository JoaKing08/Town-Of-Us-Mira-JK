...
public sealed class ExplorerOptions : AbstractOptionGroup<ExplorerModifier>
{
    ...
    public override Color GroupColor => TownOfUsMiraJKColors.Explorer;

    [ModdedNumberOption("TouJKOptionExplorerVentCooldown", 0f, 120f, 2.5f, MiraNumberSuffixes.Seconds)]
    public float VentCooldown { get; set; } = 25f;

    [ModdedNumberOption("TouJKOptionExplorerVentDuration", 0f, 120f, 2.5f, MiraNumberSuffixes.Seconds, zeroInfinity: true)]
    public float VentDuration { get; set; } = 10f;

    [ModdedNumberOption("TouJKOptionExplorerMaxVents", 0f, 15f, 1f, zeroInfinity: true)]
